...
//Use twitter-core and stream jars

public final class Tstream extends StatusAdapter {
	
	public static int k = 0;   // value passed to progressbar()
	public static double maxfilesize = 1000.0;
	public static long startTime = System.currentTimeMillis();
	public static String filepath = "/Users/Li/File/Java/TStream/Tweets/";
	...
	public static void main(String[] args) throws TwitterException {
		...
		date = str[0] + "_" + intdate;
		
		filepath = filepath + date + ".json";
		...
		StatusListener listener = new StatusListener() {
			...
			public void onStatus(Status status) {
				...
				if (file.length() / 1000000 < maxfilesize) {   //10485760
					double fsize = file.length() / 10000000;
					if(fsize >= k) {
						try {
							progressbar(k);
